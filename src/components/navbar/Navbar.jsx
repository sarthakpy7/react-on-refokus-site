                ...
                <div className="links flex gap-14 ml-20">
                    {["Home", "Work", "Culture", "", "News"].map(
                        (elem, index) => (
                            ...
                            >
                                {index === 1 && //&& ka mtlb isme aaega bki me ni aaega 
                                (
                                    <span
                                        style={{
                                            boxShadow: "0 0 0.25em #00FF19", //double curly braces for object passing
                                        }}
                                        className="inline-block w-1.5 h-1.5 rounded-full bg-green-400"
                                    ></span>
                                )}
                                {elem.length === 0 ? ( //for tht vertical line coz it has length==0
